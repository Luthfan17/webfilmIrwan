...
<div
    ...
    <div class="flex-shrink-0 mb-4 md:mb-0 md:mr-6">
        <a href="{{ route('movies.show', $booking->movie) }}">
            <img class="w-32 rounded-lg h-auto" src="{{ $booking->movie->poster_url }}"
    ...
    <div class="flex flex-col flex-grow">
        ...
        $isPastDate = $formattedDate < $currentDate; $isPastShowtime=$booking->dateShowtime->showtime->start_time <
                $currentTime; $isCancelled=$isPastDate || ($isPastShowtime && $isToday) || $booking->status->value ==
                'cancelled';
                @endphp
